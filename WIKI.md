...
- **Excel 导出**：每组一个工作表，含时间/教室/校区/主席/秘书/专家与学生名单，导师-学生同名同色（富文本着色）；
- **Word 导出**：生成答辩排期表 docx 文档（`export_word.py`，python-docx 实现）。
